...
def UploadDropbox():
    ...
    for files in checklistlocal:
        ...
        if os.path.isfile(files):
            ...
            sCrypt2.Asymmetric_Key_Reading()
            key = urandom(16)
            iv = urandom(16)
            mac_key = urandom(16)
            auth = sCrypt2.encrypt_then_mac(files, iv, key, mac_key, 16)
            print("Auth:" + str(auth))
            crypted_file_content = sCrypt2.combine_keys(maillist,auth, iv, key, mac_key, sCrypt2.blocksize)
            print("Gönderildi1")
...
def DownloadFile(file_from,file_name):
    ...
    print("********************************2")
    success,original_file,console=sCrypt2.separate_File(combine_File)
    print("********************************3")
...
if __name__ == '__main__':
    ...
    #sCrypt2.Asymmetric_Key_Generating()
    #SetMail("mert_1998_61@hotmail.com")
    #sCrypt2.Asymmetric_Key_Reading()
    #key = urandom(16)
    #iv = urandom(16)
    #mac_key = urandom(16)
    #auth = sCrypt2.encrypt_then_mac('C:/Users/pc/Desktop/Hex-Map-3.pdf', iv, key, mac_key, 16)
    #print("Auth:" + str(auth))
    #Auth Şifreli Dosya ve doğrulaması

    #combine_File = sCrypt2.combine_keys(maillist,auth, iv, key, mac_key, sCrypt2.blocksize)
    #C:/Users/pc/Desktop/denemee_c.txt
    #ths = open("C:/Users/pc/Desktop/Hex-Map-3_c.pdf", "w")
    #ths.write(combine_File),
    #ths.close()
    #combine_File=open('C:/Users/pc/Desktop/Hex-Map-3_c.pdf').read()
    ...
    #imza=sCrypt2.Asymmetric_Sign(combine_File,sCrypt2.private_key)
    #sCrypt2.Asymmetric_Auth(combine_File,imza,sCrypt2.public_key)

    #try:
    #   success, original_file, console=sCrypt2.separate_File(combine_File)
     #  print(success)
     #  #print(original_file)
     #  ths = open("C:/Users/pc/Desktop/Hex-Map-3_2.pdf", "wb")
     #  ths.write(original_file),
      # ths.close()
